                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="index.php">
                                    <p><span class="page-title">RS Budi Sehat</span></p>
                                </a>
                            ...
                            <form method='post'>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" name="ad_email" type="email" id="emailaddress" required="" placeholder="Masukkan Email Anda">
                                </div>

                                <div class="form-group mb-3">
                                    <label for="password">Password</label>
                                    <input class="form-control" name="ad_pwd" type="password" required="" id="password" placeholder="Masukkan password">
                                </div>

                                <div class="form-group mb-0 text-center">
                                    <button class="btn btn-primary btn-block" name="admin_login" type="submit"> Login Admin </button>
                                </div>
                            </form>
                        </div> 
                    </div>
